...
const App = (props) => {
  ...
  useEffect(() => {
    ...
    if (location.pathname === '/') {
      ...
      } else if (initURL === '' || initURL === '/' || initURL === '/login' || initURL == '/cambiar-contrasenia') {
    ...
    <ConfigProvider locale={currentAppLocale.antd}>
        <IntlProvider
            ...
            <Switch>
                ...
                <Route exact path='/login' component={LoginVideo}/>
                <Route exact path='/recuperar' component={Recuperar}/>
                <Route path='/cambiar-contrasenia' component={FormularioCambiarContrasenia}/>
